...
<html>
    <head>
        <title>All Exposed Infant Clients</title>
                                                ...
                                                <tbody>
                                                    <c:forEach var="patient" items="${patients}">
                                                        <tr class="gradeX">
                                                            ...
                                                            <td>
                                                                <a href="ARTPatientCard?${patient.exposedInfantId}&${patient.exposedInfantId}">
                                                                    ${patient.exposedInfantId}
                                                                </a>
                                                            </td>
                                                            ...
                                                            <td><a href="EISingleClientDashboard?${patient.exposedInfantId}">
