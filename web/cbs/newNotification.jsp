                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="default" action="Notification" method="post">
                                ...
                                <fieldset title="Step 5" class="step" id="default-step-4" >
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <label class="control-label col-xs-3">Rapid Test for HIV Infection: </label>
                                        <div class="col-lg-2">
                                    ...
                                    <div class="form-group form-group-1g">
                                        <div id="recent" style="display: none;">
                                            <label class="control-label col-xs-3" > Tester Name: </label>

                                            <div class="col-lg-2">
                                                <input type="text" class="form-control"  name="txtCBSrecenttestername">
                                            </div>
                                ...
                                <fieldset title="Step 6" class="step" id="default-step-5" >
                                    <legend>Risk Behaviors In The past 12 Months</legend>
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Did you have unprotected sex with a male partner :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Did you have unprotected sex with a female partner :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Did you have sex with a sex worker:</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label  style="color: blue;" class="col-lg-5 control-label">Did you have sex for money or other material possessions:</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Have you been in prison :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Have you received any medical injections :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Have you injected heroin or other ILICIT drugs :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Have you received a blood transfusion(Predisposing Factor) :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <label class="col-lg-5 control-label">Do you have a history of STI in the past 12 months :</label>
                                        <div class="col-lg-7">
                                    ...
                                    <div style="color: blue;" class="form-group">
                                        ...
                                        <div style="color: blue;" class="form-group">
                                            <label class="col-lg-5 control-label">Probable route of Transmission(Conclusion by clinician)</label>
                                            <div class="col-lg-5">
                                                <input type="text" class="form-control"  id="CBSType3ResultDate" name="txtprobabletransimission" onchange="Valdate6b()">
                                            </div>
                                        </div>
