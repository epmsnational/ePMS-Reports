<%-- 
    Document   : newNotificationMidTeens
    Created on : Jun 13, 2019, 2:17:30 PM
    Author     : DevOOP
--%>
...
<html>
    <head>
        <title>Case Based Surveillance:: 12 - 14 years</title>
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="default" action="NotificationMidTeens" method="post">
