<%-- 
    Document   : systemBackup
    Created on : Aug 24, 2020, 3:00:56 PM
    Author     : chihw
--%>
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="container" style="margin-left: 25%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 50%">
                                    <form class="form-horizontal"  id="default" action="SystemBackup"  method="POST">
                                        <div class="form-group" style="color: blue;">
                                            <div class="col-lg-4" style="color: blue;"><b>MySQL Server Password:</b></div>
                                            <div class="col-lg-4">
                                                <input style="color: blue;" type="password" class="form-control" required="required" id="txtPassword" name="txtPassword" >
                                            </div>
