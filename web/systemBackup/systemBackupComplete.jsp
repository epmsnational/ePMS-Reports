<%-- 
    Document   : systemBackupStatus
    Created on : Aug 24, 2020, 6:26:30 PM
    Author     : chihw
--%>
                            ...
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 50%">
                                    <form class="form-horizontal"  id="default">
                                            ...
                                            <div class="col-lg-6" style="color: blue;"><b><h3>Message:</h3></b></div>
                                            <div class="col-lg-6">
                                                <h3 style="color: red"> Backup Complete</h3>
