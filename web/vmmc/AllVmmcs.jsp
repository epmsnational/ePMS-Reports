                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <div class="alert alert-success">
                                     <span><h3>All VMMC Registered Clients</h3></span>   
                                    </div>
                                </div><!-- /.box-header -->
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="patient" items="${patients}">
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                             <a href="VmmcPatientCard?${patient.vmmcId}&${patient.opdnumber}">
                                                                    ${patient.vmmcId}
                                                                </a>
                                                           </td>
                                                        ...
                                                        <td><a href="VmmcSingleClientDashboard?${patient.vmmcId}">View</a></td>
                                                    </tr>
                                                </c:forEach>
