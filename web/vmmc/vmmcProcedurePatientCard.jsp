...
<html>
    ...
    <head>
        <title>Vmmc Screening::Patient card</title>
                    ...
                    <div class="col-lg-10" >
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <span type="button" class="btn btn-shadow btn-primary"><a href="ProgReferred?prog=ART&opdNum=${pmodel.patient.opdnumber}">OI ART PROGRAM</a></span>
                                <span type="button" class="btn btn-shadow btn-success">CBS PROGRAM</span>
                                <span type="button" class="btn btn-shadow btn-danger">STI PROGRAM</span>
                                <span type="button" class="btn btn-shadow btn-warning">TB PROGRAM</span>
                                <span type="button" class="btn btn-shadow btn-info">PHARMACY</span>
                            </div>
                        </section>
                        <!--tab nav start-->
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="screening-3" class="tab-pane">
                                        ...
                                        <div class="col-lg-4"><b>How client leant about VMMC :</b></div><div class="col-lg-6">
                                            <ol>
                                    ...
                                    <div id="vitals-3" class="tab-pane">
                                        ...
                                        <div class="col-lg-4"><b>Weight:</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.weight} <br> <hr></div>
                                        <div class="col-lg-4"><b>Temperature :</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.temperature} <br> <hr></div>
                                        <div class="col-lg-4"><b>Blood Pressure</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.bloodPressure} <br> <hr></div>
                                        <div class="col-lg-4"><b>Pulse:</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.pulse} <br> <hr></div>
                                  ...
                                  EDIT VITALS
                                    ...
                                    <div id="medicaltests-3" class="tab-pane">
                                        ...
                                        <div class="col-lg-4"><b>Previous HIV testing results:</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.ifTestedResult} <br> <hr></div>
                                        <div class="col-lg-4"><b>VMMC HIV testing results :</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.hivtestResult} <br> <hr></div>
                                        <div class="col-lg-4"><b>CD4 Count if positive</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.cd4cellCount} <br> <hr></div>
                                        <div class="col-lg-4"><b>WHO Stage if positive</b></div><div class="col-lg-6">${pmodel.vmmcMedScreening.whoclinicalStage} <br> <hr></div>

                                    </div>
                                    <div id="informedconsent-3" class="tab-pane">

                                        <h2>INFORMED CONSENT& MC METHODS</h2>


                                        <div class="col-lg-4"><b>Informed consent granted:</b></div><div class="col-lg-6">${pmodel.vmmcCircumMethod.informedConsentGranted} <br> <hr></div>

                                        <div class="col-lg-4"><b>Eligible Methods</b></div><div class="col-lg-6">${pmodel.vmmcCircumMethod.circumcisionMethod} <br> <hr></div>
                                        <div class="col-lg-4"><b>Appropriate Method:</b></div><div class="col-lg-6">${pmodel.vmmcCircumMethod.circumcisionChosenByClients} <br> <hr></div>
