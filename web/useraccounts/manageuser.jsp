                    ...
                    <div style="width: 80%;margin-left: auto; margin-right: auto;">
                       <section class="panel">
                          <header class="panel-heading">
                              Current Roles of userId ${username}
                          </header>
                          <div class="panel-body">
                              <c:forEach var="role" items="${roles}">
                                  <a href="RemoveRole?${username}&${role.roleId}" title="Click to Remove this Role" ><span  class="btn btn-shadow btn-success">${role.roleId}     </span></a> 
                              </c:forEach>
