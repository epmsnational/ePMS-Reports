<%-- 
    Document   : CSReport
    Created on : Dec 16, 2019, 10:04:53 PM
    Author     : devoop
--%>
...
<html>
    ...
    <head>
        <title>Export  Congenital Case Report </title>
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal"  name="CongenitalCaseReportAll" id="default" action="CongenitalCaseReportAll"  method="POST">
