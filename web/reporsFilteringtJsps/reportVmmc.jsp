                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal"  name="VmmcPeriodicReport" id="default" action="VmmcPeriodicReport"  method="POST">
                                ...
                                <input type="submit" class="finish btn btn-danger"  value="Populate Report" />
                            </form>
                        </div>
                    </section>
                </section>
