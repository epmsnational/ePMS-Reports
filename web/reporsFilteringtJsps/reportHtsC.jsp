...
<html>
    ...
    <head>
        <title>HTS COMMUNITY REPORT</title>
            ...
            <section class="wrapper site-min-height">
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesS1to12C" id="default" action="ReportDatesS1to12C"  method="POST">
                                        <legend> Choose The Desired Period</legend>
                                        <div class="form-group" style="color: blue;">
                                            <div class="col-lg-2" style="color: blue;"><b>START:</b></div>
                                            <div class="col-lg-4">
                                                <input style="color: blue;" type="date" class="form-control" placeholder="start date" id="txtRptStartDate" name="txtRptStartDate" >
                                            </div>
                                            <div class="col-lg-2" style="color: blue;"><b> END:</b></div>
                                            <div class="col-lg-4">
                                        ...
                                        <div style="margin: 0 auto;width: 100px">
                                            <input type="submit" class="finish btn btn-info"  value="Accept" />
                                        </div>
                                    </form>
                                </div>
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="HtsCommunityReport" id="default" action="HtsCommunityReport"  method="POST">
                                        <legend> Choosen Period</legend>
                                        <div class="form-group" style="color: blue;">
                                            <div class="col-lg-2" style="color: blue;"><b>START:</b></div>
                                            <div class="col-lg-4">
                                                <input style="color:blue" readonly="readonly" type="text" class="form-control" name="txtstartdate" value="<c:out value="${startDate}"/>">
                                            </div>
                                            <div class="col-lg-2" style="color: blue;"><b> END:</b></div>
                                            <div class="col-lg-4">
                                                <input style="color:blue" readonly="readonly" type="text" class="form-control" name="txtenddate" value="<c:out value="${endDate}"/>">
                                            </div>
                                        </div>
                                        <div style="margin: 0 auto;width: 100px">
                                            <input type="submit" class="finish btn btn-danger"  value="Populate" />
                                        </div>
                                    </form>
                                </div>
                            </div>       
