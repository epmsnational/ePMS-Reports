                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesPr1to3" id="default" action="ReportDatesPr1to3"  method="POST">
                                ...
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="PrepReport" id="default" action="PrepReport"  method="POST">
