...
<html>
    ...
    <head>
        <title>HTS FACILITY REPORT</title>
                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesS1to12F" id="default" action="ReportDatesS1to12F"  method="POST">
                                ...
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="HtsFacilityReport" id="default" action="HtsFacilityReport"  method="POST">
