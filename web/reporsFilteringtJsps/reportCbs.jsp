<%-- 
    Document   : reportCbs
    Created on : Jun 19, 2020, 7:31:11 AM
    Author     : chihw
--%>
                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesC" id="default" action="ReportDatesC"  method="POST">
                                ...
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="CBSReport" id="default" action="CBSReport"  method="POST">
