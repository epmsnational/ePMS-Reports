                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesC1to21" id="default" action="ReportDatesC1to21"  method="POST">
                                ...
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="ArtPeriodicReport" id="default" action="ArtPeriodicReport"  method="POST">
