                        ...
                        <div class="container" style="margin-left: 0.7%">
                            <div class="row">
                                <div class="col-xs-6" style="background-color: grey;width: 49%">
                                    <form class="form-horizontal" name="ReportDatesP1to36" id="default" action="ReportDatesP1to36"  method="POST">
                                ...
                                <div class="col-xs-6" style="background-color: wheat;width: 46%">
                                    <form class="form-horizontal"  name="PmtctReport" id="default" action="PmtctReport"  method="POST">
