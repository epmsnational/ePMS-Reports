                            ...
                            <form class="form-horizontal" id="default" action="HtsPatient" method="POST">
                                ...
                                <fieldset title="Step 1" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input  type="text" class="form-control"  name="txtHtcNo" id="htsNotxt" placeholder="PP-DD-FF-YYYY-E-00000" maxlength="21" required="required">
                                        </div>
                                ...
                                <fieldset title="Step 2" class="step" id="default-step-1" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="part7a" style="display: none;">
                                            <label class="col-lg-2 control-label">Comunity based </label>
                                            <div class="col-lg-2">
                                ...
                                <fieldset title="Step 3" class="step" id="default-step-2" >
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label"> Counselling Received </label>
                                        <div class="col-lg-3">
                                            <select name="txtCounsellingreceived" class="form-control">
                                                <option> </option>
                                                <option value="Group education">Group education</option>
                                                <option value="Individual Pre-Test Information">Individual Pre-Test Information</option>                                                  
                                            </select>
                                    ...
                                    <div class="form-group" id ="part1" style="display: none;" >
                                        ...
                                        <div class="col-lg-2">
                                            ...
                                            <select class="form-control" id="testedBefore" name="txtTestedBefore"  onchange="showDiv2(this)">
                                                <option> </option>
                                                <option value="No">No</option>
                                                <option value="Yes">Yes</option>                                                  
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">Name of counsellor / person who collected Blood</label>
                                        <div class="col-lg-3">
                                ...
                                <fieldset title="Step 5" class="step" id="default-step-4" >
                                    ...
                                    <div class="form-group" id="opt1" style="display: none;">
                                        <div class="form-group">
                                            <label style="color: blue;"class="col-lg-3 control-label"> Received Result</label>
                                            <div class="col-lg-2">

                                                <select class="form-control" name="txtReceivedResult" >
                                                    <option> </option>
                                                    <option value="No">No</option>
                                                    <option value="Yes">Yes</option>                                                  
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <label style="color: blue;"class="col-lg-3 control-label">Post test counseled </label>
                                            <div class="col-lg-2">

                                                <select class="form-control" name="txtPostTestCounselling" onchange="showDiv6(this)"  >
                                                    <option> </option>
                                                    <option value="No">No</option>
                                                    <option value="Yes">Yes</option>                                                   
                                                </select>
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label" style="color: blue;"> Referred To </label>
                                        <div class="col-lg-2">
