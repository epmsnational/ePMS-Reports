                                        ...
                                        <table  class="display table table-bordered table-striped" id="example">
                                            ...
                                            <tbody>
                                                <c:forEach var="patient" items="${patients}">
                                                    <tr class="gradeX">                                                
                                                        <td class="center hidden-phone">${patient.id.patientId}</td> 
                                                        <td class="center hidden-phone">${patient.id.statusDate}</td>
                                                        <td class="center hidden-phone">${patient.status}</td>  
                                                        <td class="center hidden-phone">${patient.transferOutToWhere}</td>                                  
                                                   <td class="center hidden-phone">${patient.notes}</td>                                  
