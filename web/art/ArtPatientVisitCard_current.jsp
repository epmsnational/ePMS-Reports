                    ...
                    <div class="col-lg-10" >
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue tab-right FontBig FontTimes ">
                                ...
                                <input type="hidden" id="facilityCode" value="${pmodel.patient.opdnumber}" />
                                <input type="hidden" id="vmmcId" value="${pmodel.patient.opdnumber}" />
                                <input type="hidden" id="tbId" value="${pmodel.patient.opdnumber}" />
                                <input type="hidden" id="htsId" value="${pmodel.patient.opdnumber}" />
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div id="personal-3" class="tab-pane active">
                                        ...
                                        <div class="col-lg-4"><b>Patient ID:</b></div>
                                        ...
                                        <div class="col-lg-4"><b>Educational Level:</b></div>
                                    ...
                                    <div id="tbstatus-3" class="tab-pane">
                                        ...
                                        <div class="col-lg-4"><b> IPT Reason :</b></div><div class="col-lg-6">${pmodel.oiartvisit.iptreasonCode} <br> <hr></div>
                                        <div class="col-lg-4"><b>TB Investigation:</b></div><div class="col-lg-6">${pmodel.oiartvisit.tbinvestigationResults} <br> <hr></div>
                                        <div class="col-lg-4"><b>IPT Legibility :</b></div><div class="col-lg-6">${pmodel.oiartvisit.isIpteligibility} <br> <hr></div>
                                    ...
                                    <div id="arv-3" class="tab-pane">
                                        <h2>ARV  </h2>
                                        <div class="col-lg-4"><b>Patient Cohort Number:</b></div>
                                        <div class="col-lg-6">${pmodel.patient.fileRef} <br> <hr></div>
                                        <div class="col-lg-4"><b>Arv Status code :</b></div><div class="col-lg-6">${pmodel.oiartvisit.arvstatusCode} <br> <hr></div>
                                        <div class="col-lg-4"><b> ARV reason:</b></div><div class="col-lg-6">${pmodel.oiartvisit.arvreasonCode} <br> <hr></div>
                                        <div class="col-lg-4"><b>ARV Code :</b></div><div class="col-lg-6">${pmodel.oiartvisit.arvcode} <br> <hr></div>
        ...
        $(document).on("click", "#saveChanges", function () {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    window.location = "ArtVisitClientCard?" + formKey;
                },
