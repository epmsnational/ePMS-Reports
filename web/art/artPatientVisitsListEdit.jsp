<%-- 
    Document   : artPatientVisitsListEdit
    Created on : Mar 16, 2021, 1:38:18 PM
    Author     : ignatious
--%>
                ...
                <div style="width:80%;margin-left: auto;margin-right: auto; min-height: 700px;">
                    ...
                    <section class="wrapper">
                        <section class="content-header" style="text-align: center;">
                            <h1>
                               ${client.p.firstName} ALL VISITS TO EDIT
                            </h1>
                        </section>
                        <hr>
                        <div class="col-md-12">
                                    ...
                                    <div class="task-content">
                                        ...
                                        <ul class="task-list">
                                            <c:forEach var="viz" items="${visitlst}">
                                                ...
                                                <div class ="skin-blue">
                                                    <a class="btn btn-info btn-default pull-center" href="ArtVisitClientEdit?${viz.id.visitDate}&${viz.id.patientId}" >
                                                        ${viz.id.visitDate}
                                                    </a>
                                                    <div>
                                                        <a class="btn btn-block btn-flat pull-center"> </a>
