<%-- 
    ...
    Created on : Dec 13, 2020, 6:36:12 PM
    Author     : ignatious
--%>
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="container">
                                <h2 class="form-signin-heading" style="color: red;">No such ART patient in system, check for incorrect ART number</h2>
                            </div>
                            <div class="container">
                                <div class="col-xs-6" style="background-color: grey;width: 100%">
                                    <form class="form-horizontal" action="singleArtPatientSearch"  method="POST">
