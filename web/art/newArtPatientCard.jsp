<%-- 
    Document   : newArtPatientCard
    Created on : Nov 28, 2019, 8:19:40 AM
    Author     : devoop
--%>
                            ...
                            <div class="panel-body">
                                <div class="tab-content">
                                    ...
                                    <div id="visit-3" class="tab-pane">
                                        ...
                                        <div class="col-md-12">
                                            <div class="btn btn-info btn-lg turned-button" data-toggle="modal" data-target="#myModal">Edit Details</div>
                                        </div>
                                    ...
                                    <div id="arv-3" class="tab-pane">
                                        ...
                                        <div class="col-lg-4"><b>ART Regimen :</b></div><div class="col-lg-6">${regimen} <br> <hr></div>
                                        <div class="col-lg-4"><b>ART Combination :</b></div><div class="col-lg-6">${description} <br> <hr></div>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" id="reused_form" action="ArtEditVisit">
                                                        <div class="form-group">
                                                            <label> Patient ID:</label>
                                                            <input type="text" class="form-control" id="patientid" name="patientid" value="<c:out value="${pmodel.patient.patientId}"/>" readonly="readonly">
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Visit Date:</label>
                                                            <input type="text" class="form-control" id="visitdateold" name="visitdateold" value="<c:out value="${pmodel.oiartvisit.id.visitDate}"/>" readonly="readonly">
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Visit Date:</label>
                                                            <input type="text" class="form-control" id="visitdate" name="visitdate" value="<c:out value="${pmodel.oiartvisit.id.visitDate}"/>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label > Visit Type:</label>
                                                            <input type="text" class="form-control" id="visittype" name="visittype" value="<c:out value="${pmodel.oiartvisit.visitType}"/>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label > WHO Stage:</label>
                                                            <input type="text" class="form-control" id="whostage" name="whostage" value="<c:out value="${pmodel.oiartvisit.whostage}"/>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label > ART Regimen:</label>
                                                            <input class="form-control" id="artregimen" name="artregimen" value="<c:out value="${pmodel.oiartvisit.arvcode}"/>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label > Adverse Event:</label>
                                                            <input class="form-control" id="adverseevent" name="adverseevent" value="<c:out value="${pmodel.oiartvisit.adverseEventsStatusCode}"/>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label > Next Review Date:</label>
                                                            <input class="form-control" id="nextreviewdate" name="nextreviewdate" value="<c:out value="${pmodel.oiartappointments.id.dateOfAppointment}"/>">
                                                        </div>
                                                        <button type="submit" class="btn btn-lg btn-success btn-block" id="btnedit">Edit</button>
                                                    </form>
