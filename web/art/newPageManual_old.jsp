                            ...
                            <form class="form-horizontal" id="default" action="ARTPatient" method="post">
                                <fieldset title="Step1" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input requred="required" type="text" class="form-control"  name="txtARTNum" id="artNumtxt"placeholder="PP-DD-FF-YYYY-A-00000" maxlength="21" required="required">
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group col-sm-6">
                                            <table>
                                                ...
                                                <tr><td>Full name:<input type="text" class="form-control" name="txtOIPersonalTracingFullname"></td></tr>
                                                ...
                                                <tr><td>Full name:<input type="text" class="form-control" name="txtOIIndexTestingFullname"></td></tr>
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <table>
                                                ...
                                                <tr><td><div id ="part2" style="display: none;">Full name:<input type="text" class="form-control" name="txtOIStatusDisclosureFullname"></div></td></tr>
                                ...
                                <fieldset title="Step 3" class="step" id="default-step-2">
                                    ...
                                    <div class="col-sm-12"> 
                                        <div class="form-group col-sm-2" style="text-align: left;">
                                            <div><input type="radio" name="rdIsOINew" id="optNewClient" value="NC" onchange="showDivTrans(this)"> New Client  <input type="radio" name="rdIsOINew" id="optNewClient" value="TI" onchange="showDivTrans(this)">Transfer In</div>
                                        </div>


                                        <div id ="tranferinclient" style="display: none;">
                                            <div class="form-group col-sm-4" style="text-align: left; padding-left: 10%;">
                                                <div id ="refname" style="display: block;"> 
                                            ...
                                            <div class="form-group col-sm-4" style="text-align: left; padding-left: 10%;">
                                                <div id ="refcode" style="display: block;"> 
                                                    <label>Referring Facility Code</label> 
                                                    <select name="txtOIRereralFacilityCode" class="form-control">
                                                        <option> </option>
                                                        <c:forEach var="facility" items="${failitylist}">
                                                            <option value="${facility.provinceId + facility.districtId+facility.facilityCode}">${facility.facilityName}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div> 
                                    ...
                                    <div class="col-sm-12" id ="newclient" style="display: none;">      
                                        <div class="form-group col-sm-3" style="text-align: left; ">
                                            <label >Linkage from(if number is not available name of referring institution must be written) </label>
                                        ...
                                        <div class="form-group col-sm-4" style="text-align: left; padding-left: 10%;">
                                            ...
                                            <div id ="div1a" style="display: none;">  <input type="text" class="form-control" name="txtOIEIDNumber"  id="eidtxt" placeholder="PP-DD-FF-YYYY-E-00000" maxlength="21"></div>
                                            <div id ="div1b" style="display: none;">  <input type="text" class="form-control" name="txtOIHTSNumber" id="htstxt" placeholder="PP-DD-FF-YYYY-V-00000" maxlength="21"></div>
                                            <div id ="div1c" style="display: none;"> <input type="text" class="form-control" name="txtOIPMTCTNumber" id="pmtcttxt" placeholder="PP-DD-FF-YYYY-P-00000" maxlength="21"></div>
                                            <div id ="div1d" style="display: none;"><input type="text" class="form-control" name="txtOISTINumber" id="stitxt" placeholder="PP-DD-FF-YYYY-S-00000" maxlength="21"></div>
                                            <div id ="div1e" style="display: none;"> <input type="text" class="form-control" name="txtOITBNumber" id="tbtxt" placeholder="PP-DD-FF-YYYY-T-00000" maxlength="21"></div>
                                            <div id ="div1f" style="display: none;"> <input type="text" class="form-control" name="txtOIVMMCNumber" id="vmmctxt" placeholder="PP-DD-FF-YYYY-M-00000" maxlength="21"></div>
                                            <div id ="div1g" style="display: none;"><input type="text" class="form-control" name="txtOIOtherProgNum" id="othertxt" placeholder="PP-DD-FF-YYYY-O-00000" maxlength="21"></div>
                                    ...
                                    <div class="col-sm-12"> 
                                        ...
                                        <div class="form-group col-sm-4" style="text-align: left; padding-left: 10%;">
                                            ...
                                            <div > <input type="text" class="form-control" name="txtOICohort" id="cohorttxt" placeholder="MM-YYYY-000" maxlength="11" ></div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group col-sm-6">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div id="div3a" style = "Display : none;">Date of HIV Re-test</div></td>
                                                    <td colspan="2">
