                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    OI/ART Viral Load Due on next visit
                                </header>
                                    ...
                                    <div class="adv-table">
                                        ...
                                        <div id="contentLoader">
                                            ...
                                            <table  class="display table table-bordered table-striped" id="example">
                                                ...
                                                <tbody>
                                                    <c:forEach var="vrldeu" items="${dueVL}">
                                                        <tr class="gradeX">
                                                            <td class="center hidden-phone">${vrldeu.id.patientId}</td>     
                                                            <td class="center hidden-phone">${vrldeu.visitType}</td>
                                                            <td class="center hidden-phone">${vrldeu.arvstatusCode}</td>
                                                            <td class="center hidden-phone">${vrldeu.id.visitDate}</td>
