                            ...
                            <form class="form-horizontal" id="default" action="ARTPatient" method="post">
                                <fieldset title="Step1" class="step" id="default-step-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input readonly="readonly" type="text" class="form-control"  name="txtARTNum" value="<c:out value="${oinumber}"/>">
                                        </div>
                                ...
                                <fieldset title="Step 3" class="step" id="default-step-2">
                                    ...
                                    <div class="col-sm-12"> 
                                        ...
                                        <div class="form-group col-sm-2">
                                               <table cellpadding="2">
                                                <tr>
                                                    <td><label>Linkage from hhh(if number is not available name of referring institution must be written) </label></td>
                                                </tr><tr>
                                                    <td colspan="2">
                                        ...
                                        <div class="form-group col-sm-2" style="text-align: left; padding-left: 10%;">
                                            
                                            
                                            <div id ="div1a" style="display: none;"> <label>EID</label> <input type="text" class="form-control" name="txtOIEIDNumber"  id="eidtxt" placeholder="PP-DD-FF-YYYY-E-00000" maxlength="21"></div>
                                            <div id ="div1b" style="display: none;"> <label>HTS</label> <input type="text" class="form-control" name="txtOIHTSNumber" id="htstxt" placeholder="PP-DD-FF-YYYY-V-00000" maxlength="21"></div>
                                            <div id ="div1c" style="display: none;"><label>PMTCT</label> <input type="text" class="form-control" name="txtOIPMTCTNumber" id="pmtcttxt" placeholder="PP-DD-FF-YYYY-P-00000" maxlength="21"></div>
                                            <div id ="div1d" style="display: none;"><label>STI</label> <input type="text" class="form-control" name="txtOISTINumber" id="stitxt" placeholder="PP-DD-FF-YYYY-S-00000" maxlength="21"></div>
                                            <div id ="div1e" style="display: none;"><label>TB PROGRAM</label> <input type="text" class="form-control" name="txtOITBNumber" id="tbtxt" placeholder="PP-DD-FF-YYYY-T-00000" maxlength="21"></div>
                                            <div id ="div1f" style="display: none;"><label>VMMC</label> <input type="text" class="form-control" name="txtOIVMMCNumber" id="vmmctxt" placeholder="PP-DD-FF-YYYY-M-00000" maxlength="21"></div>
                                            <div id ="div1g" style="display: none;"><label>OTHER</label> <input type="text" class="form-control" name="txtOIOtherProgNum" id="othertxt" placeholder="PP-DD-FF-YYYY-O-00000" maxlength="21"></div>
