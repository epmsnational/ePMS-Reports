<%-- 
    Document   : directInfants
    Created on : Jul 5, 2020, 2:18:02 PM
    Author     : devoop
--%>
...
<html>
    <head>
        <title>Case Based Surveillance: Infants</title>
                ...
                <section class="content">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="default" action="DirectInfants" method="post">
                               <fieldset title="Step1" class="step" id="default-step-0">
                                ...
                                <fieldset title="Step 3" class="step" id="default-step-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group form-group-lg">
                                            ...
                                            <div class="col-lg-2">
                                                <select class="form-control" name="txtcbsinfantartinitiation" onchange="showDivX1v(this)">
                                                    <option></option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                            ...
                                            <div id="artInitiate" style="display: none;">
                                                ...
                                                <label class="control-label col-xs-3" > ART Regimen: </label>

                                                <div class="col-lg-2">
                                                    <input type="text" class="form-control"  name="txtcbscartregimen">
                                                </div>
                                            </div>
                                        </div>
                                </fieldset>
                                <fieldset title="Step 4" class="step" id="default-step-3">
                                    ...
                                    <div class="form-group form-group-lg">
                                        ...
                                        <label class="control-label col-xs-3" >Know HIV Status :</label>
                                        <div class="col-lg-2">
                                            <select class="form-control" name="knowhivstatus">
                                                <option></option>
                                                <option value="yes">YES</option>
                                                <option value="no">NO</option>
                                            </select>
                                ...
                                <fieldset title="Step5" class="step" id="default-step-4">
    ...
    <script language="Javascript" type="text/javascript">
        ...
        function showDivX1v(elem) {

            if (elem.value == 'no') {
                document.getElementById('artInitiate').style.display = "none";

            } else if (elem.value == 'yes') {
                document.getElementById('artInitiate').style.display = "block";
            } else {
                document.getElementById('artInitiate').style.display = "none";
