...
<html>
    ...
    <head>
        <title>STI::  ALL CLIENT STIs SYNDROMES</title>
                        ...
                        <div class="col-md-12">
                            <section class="panel tasks-widget">
                                <header class="panel-heading">
                                    <h3>SYNDROMES FOR: ${client.p.firstName}&nbsp; ${client.p.lastName} <span style="color:red">[${client.p.vmmcId}]</span> </h3>
                                </header>
