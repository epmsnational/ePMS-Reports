                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <div class="alert alert-success">
                                     <span><h3>All STI Registered Clients</h3></span>   
                                    </div>
                                </div><!-- /.box-header -->
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="patient" items="${patients}">
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                             <a href="StiPatientCard?${patient.stiId}&${patient.opdnumber}">
                                                                    ${patient.stiId}
                                                                </a>
                                                           </td>
                                                        ...
                                                        <td><a href="StiSingleClientDashboard?${patient.stiId}">View</a></td>
                                                    </tr>
                                                </c:forEach>
