    ...
    <section id="container" class="">
                    ...
                    <section class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" id="default" action="AddNewSti" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group col-sm-3">
                                                <div id ="part2c" style="display: none;" >
                                                    <div class="col-lg-4">                                                                                
                                                        <label style="color: red; text-align: center;">Male Clients Entrypoints</label>
                                                ...
                                                <div id ="part2d" style="display: none;" >
                                                    <div class="col-lg-4">                                                                                
                                                        <label style="color: red; text-align: center;">Female Clients Entrypoints</label>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="checkbox">                                                                                
                                                ...
                                                <c:forEach items="${allinfections}" var="allinfection">
                                                    <label>
                                                        <input type="checkbox" id="allinfection" name="ckallinfection" value="${allinfection.description}" onchange="showDivAllinfection(this)"> ${allinfection.description}
                                                    </label>
                                                </c:forEach>
                                            ...
                                            <div id ="part4c" style="display: none;" >
                                                <div class="checkbox">                                                                                
                                                    ...
                                                    <c:forEach items="${femaleinfections}" var="femaleinfection">
                                                        <label>
                                                            <input type="checkbox" id="femaleinfection" name="ckfemaleinfection" value="${femaleinfection.description}" onchange="showDivFemaleinfection(this)"> ${femaleinfection.description}
                                                        </label>
                                                    </c:forEach>
                                            ...
                                            <div id ="part4d" style="display: none;" >
                                                <div class="checkbox">                                                                                
                                                    ...
                                                    <c:forEach items="${maleinfections}" var="maleinfection">
                                                        <label>
                                                            <input type="checkbox" id="femaleinfection" name="ckmaleinfection" value="${maleinfection.description}" onchange="showDivMaleinfection(this)"> ${maleinfection.description}
                                                        </label>
                                                    </c:forEach>
                                                ...
                                                <div id ="part4f" style="display: none;" >
                                                    <div class="checkbox">                                                                                
                                                        ...
                                                        <c:forEach items="${maleInfantsinfections}" var="maleInfantsinfection">
                                                            <label>
                                                                <input type="checkbox" id="maleInfantsinfection" name="ckmaleInfantsinfection" value="${maleInfantsinfection.description}" onchange="showDivMaleInfantsinfection(this)"> ${maleInfantsinfection.description}
                                                            </label>
                                                        </c:forEach>
                                                ...
                                                <div id ="part4g" style="display: none;" >
                                                    <div class="checkbox">                                                                                
                                                        ...
                                                        <c:forEach items="${femaleinfantsinfections}" var="femaleinfantsinfection">
                                                            <label>
                                                                <input type="checkbox" id="femaleinfantsinfection" name="ckfemaleinfantsinfection" value="${femaleinfantsinfection.description}" onchange="showDivFemaleInfantsinfection(this)"> ${femaleinfantsinfection.description}
                                                            </label>
                                                        </c:forEach>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-3">
                                                    <select name="txtDeliveryOutcome" class="form-control">
                                                        <option> </option>
                                                        <option value="still birth"> Still birst</option>
                                                        <option value="live birth"> Live birst </option>
                                ...
                                <fieldset title="Step 7" class="step" id="default-step-1" >
        ...
        <script language="Javascript" type="text/javascript">
            ...
            function showDivMaleinfection(elem) {
                if (elem.value == 'Scrotum Infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Urethral infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Penal Fore-skin Infection') {
                    if (elem.checked) {
            ...
            function showDivAllinfection(elem) {
                ...
                if (elem.value == 'Anal or Rectal Infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Genital Infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Inguinal infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Skin or pubic infections') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Anal and genital warts') {
                    if (elem.checked) {
            ...
            function showDivFemaleinfection(elem) {
                ...
                if (elem.value == 'Lower Abdominal Pain') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Vaginal infection') {
                    if (elem.checked) {
                ...
                if (elem.value == 'Cervical infection') {
                    if (elem.checked) {
            ...
            function showDivFemaleInfantsinfection(elem) {
                ...
                if (elem.value == 'Eye or systemic infection') {
                    if (elem.checked) {
