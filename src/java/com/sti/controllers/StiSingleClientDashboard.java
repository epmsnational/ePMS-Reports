 ...
 * @author Training3
 */
public class StiSingleClientDashboard extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StiSingleClientDashboard</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StiSingleClientDashboard at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       String stiId =null;
        ...
        stiId=request.getQueryString().replace("%", " ");

        
        CompletedStiClientAll client = new CompletedStiClientAll(stiId);
        //client.getp
        ...
        Patient p = pp.getStiPatient(stiId);
        ...
        if (client != null) {
         //   VmmcCircumcisionmethod method = client.getVcm().get(0);
                ...
                disp = request.getRequestDispatcher("/sti/STISingleClientDashboard.jsp");
