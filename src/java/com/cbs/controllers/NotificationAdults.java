 ...
 * @author Trevor
 */
@WebServlet(name = "NotificationAdults", urlPatterns = {"/NotificationAdults"})
public class NotificationAdults extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String htsnum = p.getHtsId();
        HtsablePatientImpl hts = new HtsablePatientImpl();
        Htc htc = hts.getHtsPatient(htsnum);
        ...
        if (age >= 15) {
            ...
            RequestDispatcher disp = request.getRequestDispatcher("cbs/newNotificationPaeds_1.jsp");
            disp.forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String cbsViralLoad2 = request.getParameter("txtCBSViralLoadresult2");
