 ...
 * @author ignatious
 */
public class singleArtPatientSearchByName extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet singleArtPatientSearchByName</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet singleArtPatientSearchByName at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String patientName = request.getParameter("txtARTName");
        
        CircumcisablePatientImpl OIARTpp = new CircumcisablePatientImpl();
        List<Patient> listClients = OIARTpp.getPatientByName(patientName);
        ...
        RequestDispatcher disp = request.getRequestDispatcher("art/AllOIPatients.jsp");
