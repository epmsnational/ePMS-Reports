 ...
 * @author Developer
 */
@WebServlet(name = "ArtClientVisits", urlPatterns = {"/ArtClientVisits"})
public class ArtClientVisits extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dis = request.getRequestDispatcher("art/artPatientVisits.jsp");
