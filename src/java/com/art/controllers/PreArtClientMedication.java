 ...
 * @author chihw
 */
public class PreArtClientMedication extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PreArtClientMedication</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PreArtClientMedication at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Tblmedication> medlst = cptdArtClient.getMedication();
        
        request.setAttribute("patient", patient);
        request.setAttribute("medlst", medlst);
        RequestDispatcher dis = request.getRequestDispatcher("art/PreArtClientMedication.jsp");
