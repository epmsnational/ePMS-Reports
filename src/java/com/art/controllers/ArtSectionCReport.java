...
import com.reports.controllers.GenerateCReport;
 ...
 * @author ignatious
 */
public class ArtSectionCReport extends HttpServlet {

    GenerateCReport gen = new GenerateCReport();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ArtSectionCReport</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ArtSectionCReport at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("reporsFilteringtJsps/reportArtSectionC.jsp").forward(request, response);
    }
...
//        InputStream input = new FileInputStream(file);
        ...
        if (repo == 1) {
            response.sendRedirect("ArtReportGenerationC");
        }
    }
