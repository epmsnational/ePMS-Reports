 ...
 * @author chihw
 */
public class ArtFollowUpContacts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ArtFollowUpContacts</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ArtFollowUpContacts at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CircumcisablePatientImpl patient = new CircumcisablePatientImpl();
        Patient pat =  patient.getOIArtPatient(oinumber);
        
        String opdnumber = pat.getOpdnumber();
        
        CompleteGenericPatient cgp = new CompleteGenericPatient(opdnumber);
        ...
        request.getRequestDispatcher("art/ArtFollowUpContacts.jsp").forward(request, response);
    }
