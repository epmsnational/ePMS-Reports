...
import com.reports.controllers.GenerateDReport;
import com.reports.controllers.GenerateReport;
 ...
 * @author ignatious
 */
public class ArtSectionDReport extends HttpServlet {
    
    GenerateDReport gen =new GenerateDReport();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ArtSectionDReport</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ArtSectionDReport at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("reporsFilteringtJsps/reportArtSectionD.jsp").forward(request, response);
    }
...
//        InputStream input = new FileInputStream(file);
        ...
        if(repo == 1){
            response.sendRedirect("ArtReportGenerationD");
        }
    }
